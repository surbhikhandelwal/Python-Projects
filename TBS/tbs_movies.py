...
driver.get('http://www.tbs.com/movies')
...
for s in range (len(shows_count)):
	...
	try:
		...
		print (e)
		pass
	res=[today, "TBS Movies", movie_title, release_year, service_videos, credit]
	with open(os.getcwd()+'/'+"TBS_output_movies"+ '.csv', 'ab+') as mycsvfile:
